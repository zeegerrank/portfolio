  ...
  return (
    ...
    >
      <div
        className={`absolute left-1 top-1 h-8 w-8 transition-all duration-700 ${
          dark
            ...
            : "bg-amber-400 ring-amber-100/25"
        } rounded-full ring-4`}
      >
        {dark ? (
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="absolute left-1 top-1 size-6 text-yellow-400"
          >
            <path
              fillRule="evenodd"
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="absolute left-1 top-1 size-6 text-amber-50"
          >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className={`absolute top-2 size-5 text-yellow-200 transition-all duration-1000 ${
          dark ? "left-1" : "-left-full"
        }`}
      >
        <path
          fillRule="evenodd"
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className={`absolute size-16 text-blue-50 transition-all duration-1000 ${
